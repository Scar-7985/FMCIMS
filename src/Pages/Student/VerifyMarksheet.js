...
{/* BreadCrumbs */}
     ...
     <div className='container-lg py-4 px-5' id='parent' >
                <div className='text-white fw-bold' style={{ fontSize: '60px' }}>Marksheet Verification</div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">Marksheet Verification</li>
                    </ol>
                </nav>
            </div>
...
{/* Form Starts */}
        ...
        <h1 className='fw-medium'>Verify Your Marksheet</h1>
        <form>
          <div class="form-floating container">
            ...
            <label for="contact" style={{ marginLeft: "20px" }}>Enter Marksheet Number</label>
          </div>
