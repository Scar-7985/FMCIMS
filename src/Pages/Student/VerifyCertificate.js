  ...
  return (
    <>
      ...
      <div className='container-lg py-4 px-5' id='parent' >
        <div className='text-white fw-bold' style={{ fontSize: '60px' }}>Certificate Verification</div>
      ...
      <div className='container-lg text-center mt-5'>
        <h1 className='fw-medium'>Verify Certificate</h1>
        <form>
          <div class="form-floating container">
            ...
            <label for="contact" style={{ marginLeft: "20px" }}>Enter Certificate Number</label>
          </div>
